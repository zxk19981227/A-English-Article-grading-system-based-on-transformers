...
train_log_dir = "./dirve/My Drive/grade/checkpoints/train" + current_time + '/train'
test_log_dir = "./dirve/My Drive/grade/checkpoints/train" + current_time + '/test'
...
class Transformer(tf.keras.Model):
    def __init__(self, num_layers, d_model, num_heads, dff, pe_input, rate=0.1):
        ...
        self.final_layer = tf.keras.layers.Dense(13, kernel_initializer='random_uniform',
                                                 bias_initializer='zeros',
                                                 kernel_regularizer=tf.keras.regularizers.l2(0.001))
...
def train_step(score, article):
    ...
    train_accuracy.update_state(score,predictions)
